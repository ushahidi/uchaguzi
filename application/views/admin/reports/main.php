...
<div id="tools-content">
	...
	<div class="page-content"> 
		...
		<div class="tabs">
			...
			<!-- tab -->
			<div class="tab cf action-tab active">
				<ul class="toolbar">
									...
									<td class="col-4 actions">
											<?php if (Auth::instance()->has_permission('reports_approve')): ?>
												...
												<a href="#" class="status_yes" onclick="reportAction('u','UNAPPROVE', '<?php echo $incident_id; ?>');">
													<i class="icon-checkmark-circle"></i>Approved
												</a>
												<?php  else: ?>
											...
											<?php if (Auth::instance()->has_permission('reports_verify')): ?>
												...
												<a href="#" class="status_yes" 
													onclick="reportAction('v','VERIFY', '<?php echo $incident_id; ?>');">
													<i class="icon-checkmark-circle"></i>Verified
												</a>
												<?php else: ?>
