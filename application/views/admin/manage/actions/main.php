...
<div id="tools-content">
	...
	<div class="page-content cf">
		<div class="table-tabs">
			<p>This is an experimental feature. The Ushahidi and Crowdmap Teams cannot be responsible for any mishaps, bugs or quirks that show up when using Actions.</p>
			<?php
			if ($form_error) {
			?>
				<!-- red-box -->
		...
		<div class="table-tabs">
			...
			<div class="tabs">
				...
				<div class="tab">
					...
					<div id="divMap" style="width:100%;height:350px;border:0px;">
						...
						<a href="#" class="btn_clear"><?php echo utf8::strtoupper(Kohana::lang('ui_main.clear_map'));?></a>
					</div>
					...
					<div id="actions_response_section">
						...
						<div class="tab_form_item" id="action_form_report_title">
						...
						<div class="tab_form_item" id="action_form_approve">
