   	...
   	<div class="pageheader">
		...
		<nav id="tools-menu">
			<ul class="second-level-menu">
				<?php election_tool::election_subtabs("monitors"); ?>
			</ul>
		</nav>
	</div>
	...
	<div class="page-content">
		<div class="table-tabs">
			...
			<div class="report-form">
				<?php print form::open(NULL,array('id' => 'monitorListing', 'name' => 'monitorListing')); ?>
				<input type="hidden" name="action" id="action" value=""> <input type="hidden" name="monitor_id" id="monitor_id_action" value="">
		...
		<div class="table-tabs">
			...
			<div class="tabs"><!-- tabset -->
				...
				<!-- tab -->
				<div class="tab">
					<?php print form::open(NULL,array('id' => 'monitorMain', 'name' => 'monitorMain')); ?> 
					...
					<div class="tab_form_item">
						Phone Number<br />
						<?php print form::input('phonenumber'); ?>
					</div>

					<div class="tab_form_item">
						Polling Station<br />
						<?php print form::input('polling_station',$form['polling_station'],''); ?>
					</div>
