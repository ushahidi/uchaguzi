	...
	<div class="page-content">
		<div class="table-tabs">
			...
			<div class="report-form">
				<?php print form::open(NULL,array('id' => 'adminsectionListing','name' => 'adminsectionListing')); ?>
				<input type="hidden" name="action" id="action" value=""> <input type="hidden" name="adminsection_id" id="adminsection_id_action" value="">
		...
		<div class="table-tabs">
			<div class="tabs">
				...
				<!-- tab -->
				<div class="tab">
					<?php print form::open(NULL,array('id' => 'adminsectionMain', 'name' => 'adminsectionMain')); ?> 
					<input type="hidden" id="adminsection_id" name="adminsection_id" value="<?php echo $form['adminsection_id']; ?>" />
					<input type="hidden" name="action" id="action" value="a" />
					<div class="tab_form_item">
						<strong><?php echo Kohana::lang('election.adminsection_title');?>:</strong><br />
						<?php print form::input('adminsection_title', $form['adminsection_title'], ' class="text long"'); ?>
					</div>
					<div class="tab_form_item">
						Report Section<br />
						<span class="my-sel-holder"><?php print form::dropdown('reportsection_id',$reportsection_array,'id'); ?></span>
					</div>
					<div class="tab_form_item">
						&nbsp;<br />
