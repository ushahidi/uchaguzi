<div id="primary-content" class="login-view col_6">
	...
	<div id="openid_login" class="login-option">
		...
		<div id="signin_userpass" class="signin_select ui-corner-all">
			<?php echo form::open(NULL, array('id'=>"userpass_form")); ?>
				...
				<table width="100%" border="0" cellspacing="3" cellpadding="4" background="" id="ushahidi_loginbox">
					...
					<tr>
						<td>
							<strong><?php echo Kohana::lang('ui_main.password');?></strong>
		...
		<div id="signin_forgot" class="signin_select">
			<?php echo form::open(NULL, array('id'=>"userforgot_form")); ?>
				<input type="hidden" name="action" value="forgot">
				<table width="100%" border="0" cellspacing="3" cellpadding="4" background="" id="ushahidi_loginbox">
					<tr>
						<td>
							<strong><?php echo Kohana::lang('ui_main.registered_email');?></strong>
	...
	<div id="create_account" class="login-option">
		...
		<div id="signin_new" class="signin_select ui-corner-all" style="margin-top:10px;">
			<?php echo form::open(NULL,  array('id' => "usernew_form")); ?>
				...
				<table width="100%" border="0" cellspacing="3" cellpadding="4" background="" id="ushahidi_loginbox">
					<tr>
						<td>
							<strong><?php echo Kohana::lang('ui_main.name'); ?></strong>
							<small><?php echo Kohana::lang('ui_main.identify_you');?></small>
							<?php print form::input('name', $form['name'], 'class="login_text new_name"'); ?>
						</td>
					</tr>
					<tr>
						<td>
							<strong><?php echo Kohana::lang('ui_main.email'); ?></strong>
							<?php print form::input('email', $form['email'], 'class="login_text new_email"'); ?>
						</td>
					</tr>
					...
					<tr>
						<td>
							<strong><?php echo Kohana::lang('ui_main.password'); ?></strong>
							<?php print form::password('password', $form['password'], 'class="login_text new_password"'); ?>
						</td>
					</tr>
					<tr>
						<td>
							<strong><?php echo Kohana::lang('ui_main.password_again'); ?></strong>
							<?php print form::password('password_again', $form['password_again'], 'class="login_text new_password_again"'); ?>
						</td>
					</tr>
					<tr>
						<td>
							<input type="submit" id="submit" name="submit" value="<?php echo Kohana::lang('ui_main.login_signup');?>" class="login_btn new_submit" />
						</td>
					</tr>
				</table>
			<?php echo form::close(); ?>
