<div id="primary-content" class="col_6">
  ...
  ?>
	...
	<h1 class="report-title"><?php
		...
		if ($logged_in)
		{
			echo " <a href=\"".url::site()."admin/reports/edit/".$incident_id."\" class=\"edit\">"
	...
	<div class="toolbar cf">
		<div class="credibility">
			<strong><?php echo Kohana::lang('ui_main.credibility');?></strong>
		...
		<span class="date"><?php echo $incident_time.' '.$incident_date; ?></span>
		<span class="location"><?php echo html::specialchars($incident_location); ?></span>
